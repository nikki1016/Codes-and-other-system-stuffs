2D Convex Hull in C++ using Divide and Conquer
There are 2 files - cdll.h and chull.cpp. 
//CDLL.H
#include<iostream>
#include<vector>
...
class convex_hull {
    ...
    //    cout<<"Coordinates sorted according to X"<<endl;
    //    print(xh);
    //    print(yh);
    }
    ...
    void run() {
        ...
        cout << "The Area of the Convex Hull is : \n" << (int)(0.5)*fabs(temp_down-temp_up) << endl;
}
